...
/** HTTP preview origins do not expose randomUUID because they are not secure contexts. */
export function createBrowserAssetId(
  cryptoApi: { readonly randomUUID?: () => string } | undefined = globalThis.crypto,
): string {
