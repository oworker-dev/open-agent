...
function partialPathFromText(value) {
    if (!value)
        return undefined;
...
function TurnFailure({ events, failure, locale, turnId }) {
    ...
    if (latestRetryEvent) {
        const data = latestRetryEvent.data;
