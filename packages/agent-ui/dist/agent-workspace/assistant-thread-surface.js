...
function ReliableCopyButton({ label, text }) {
    ...
    return (_jsx(Button, { "aria-label": label, className: "text-muted-foreground hover:bg-accent hover:text-foreground", size: "icon-xs", title: copied ? "Copied" : label, type: "button", variant: "ghost", onClick: () => {
