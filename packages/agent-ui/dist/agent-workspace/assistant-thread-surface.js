...
export function AssistantComposer({ approvalTakeover, cancellationState, commands, composerTop, draftStorageKey, draftRestore, inputDisabled = false, locale, mentions, messages, models, onPreferencesChange, onInputResponses, onDraftRestoreConsumed, preferences, reasoningLevels, usage, }) {
    const aui = useAui();
