...
function UserMessage({ messages }) {
    ...
    return (_jsxs(MessagePrimitive.Root, { className: "group fade-in slide-in-from-bottom-1 animate-in mx-auto grid w-full max-w-(--thread-max-width) auto-rows-auto grid-cols-[minmax(72px,1fr)_auto] content-start gap-y-2 px-2 duration-150 [&:where(>*)]:col-start-2", children: [_jsx(AttachmentGroup, { className: "col-start-2 mb-0 max-w-[88%] justify-end py-0 empty:hidden", children: _jsx(MessagePrimitive.Attachments, { children: ({ attachment }) => _jsx(UserAttachment, { attachment: attachment, messages: messages }) }) }), _jsxs("div", { className: "col-start-2 min-w-0", children: [_jsx("div", { className: "peer rounded-xl bg-muted px-4 py-2 text-foreground wrap-break-word empty:hidden", onClick: () => {
                        ...
                        }, children: _jsx(MessagePrimitive.Parts, { components: { Text: DirectiveText } }) }), _jsx("div", { className: cn("pointer-events-none flex min-h-7.5 items-center gap-0.5 pt-1.5 transition-opacity", actionsVisible ? "opacity-100" : "opacity-0 group-hover:opacity-100 group-focus-within:opacity-100"), children: _jsxs(ActionBarPrimitive.Root, { className: "pointer-events-auto flex items-center gap-0.5", children: [_jsx(ReliableCopyButton, { label: messages.copyResponse }), isLastUserMessage ? (_jsx(ActionBarPrimitive.Edit, { asChild: true, children: _jsx(TooltipIconButton, { "aria-label": messages.editMessage, tooltip: messages.editMessage, children: _jsx(PencilIcon, { className: "size-3.5" }) }) })) : null] }) })] })] }));
}
